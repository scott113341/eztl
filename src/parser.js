module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c15 = /^[a-zA-Z0-9_\-.]/,
        peg$c16 = { type: "class", value: "[a-zA-Z0-9\\_\\-\\.]", description: "[a-zA-Z0-9\\_\\-\\.]" },
        peg$c17 = function(v) {
    ...
    function peg$parseTag() {
      ...
      s0 = peg$currPos;
      s1 = peg$parseOpenBrackets();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseExpression();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseCloseBrackets();
          if (s3 !== peg$FAILED) {
            peg$savedPos = s0;
            s1 = peg$c5(s2);
            s0 = s1;
    ...
    function peg$parseExpression() {
      ...
      s0 = peg$parseIfControl();
      if (s0 === peg$FAILED) {
        s0 = peg$parseElseControl();
        if (s0 === peg$FAILED) {
          s0 = peg$parseEndControl();
          if (s0 === peg$FAILED) {
    ...
    function peg$parseOpenBrackets() {
      var s0, s1, s2, s3;
    ...
    function peg$parseCloseBrackets() {
      var s0, s1, s2;
